    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="moauth.jsp">Manage Owners</a></li>
  ...
  <section>
    ...
    <table>
      ...
      <tr>
        ...
        <td style="color: #007aff;"><%= rs.getString("status") %></td>
        <td><a href="mo_auth.jsp?id=<%= rs.getString("id") %>user=<%= rs.getString("user") %>" class="remove-btn">Remove Owner</a></td>
      </tr>
      <% 
          }
          rs.close();
