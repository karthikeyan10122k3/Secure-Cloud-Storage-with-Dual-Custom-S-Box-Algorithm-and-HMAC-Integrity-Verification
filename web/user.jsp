    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="user.jsp">Data Users</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
            ...
            <br>
            <div class="log mt-4">
              <form action="uloginc.jsp">
                <table style="text-align: center;">
                  <tr><td><strong>UserName </strong></td><td> <input type="text" name="user" /></td></tr>
                  ...
                  <tr align="center"><td colspan="2"><input type="submit" value="Login" />
                    <a href="ureg.jsp" style="color: #0dcaf0;">New User</a></td></tr>
                </table>
              </form>
            </div>
          </div>
          <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
            <img src="assets/img/LOGIN.jpg" class="img-fluid animated" alt="">
          </div>
        </div>
      </div>
    </section><!-- End Hero -->
