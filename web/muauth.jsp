    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="muauth.jsp">Manage Users</a></li>
  ...
  <section>
    ...
    <table>
      ...
      <tr>
        ...
        <td><a href="mu_auth.jsp?id=<%= rs.getString("id") %>user=<%= rs.getString("user") %>" class="remove-btn">Remove User</a></td>
      </tr>
      <% 
          }
          rs.close();
